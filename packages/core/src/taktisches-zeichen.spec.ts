...
describe("taktisches-zeichen", () => {
  it("should render an SVG", () => {
    ...
    expect(tz.toString()).toMatchInlineSnapshot(`
      ...
      <svg color="#ffffff" fill="transparent" stroke="black" stroke-width="2" viewBox="0 0 75 45" xmlns="http://www.w3.org/2000/svg"><defs><clipPath id="tz_taktische-formation"><path d="M1,1 H74 V44 H1 Z" /></clipPath></defs><path d="M1,1 H74 V44 H1 Z" fill="#fa321e" /></svg>"
    `);
  });
  ...
  it("should render an SVG with name", () => {
    ...
    expect(tz.toString()).toMatchInlineSnapshot(`
      "<?xml version="1.0" encoding="UTF-8"?>
      <svg color="#ffffff" fill="transparent" stroke="black" stroke-width="2" viewBox="0 0 75 45" xmlns="http://www.w3.org/2000/svg"><defs><clipPath id="tz_taktische-formation"><path d="M1,1 H74 V44 H1 Z" /></clipPath></defs><path d="M1,1 H74 V44 H1 Z" fill="#fa321e" /><g clip-path="url(#tz_taktische-formation)"><g transform="translate(3,3) scale(0.27906976744186046)"><text fill="currentColor" stroke="none" style="font-family:Roboto Slab;font-size:30px;font-weight:bold;letter-spacing:-1px" x="0" y="21.5"><![CDATA[Test]]></text></g></g></svg>"
    `);
  });
  ...
  it("should render a data URL with name", () => {
    ...
    expect(tz.dataUrl).toMatchInlineSnapshot(
      `"data:image/svg+xml;base64,"`
    );
  });
